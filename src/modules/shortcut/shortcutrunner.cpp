...
// Map Qt::KeyboardModifiers to the canonical Qt::Key for modifier-release detection.
// Priority: Meta > Alt > Control > Shift — matches the most significant held modifier.
static Qt::Key modifierToKey(Qt::KeyboardModifiers mods)
{
...
// Check whether a Qt::Key belongs to the modifier mask — supports multi-modifier
// shortcuts like Ctrl+Alt+Tab where releasing EITHER Ctrl or Alt should trigger.
