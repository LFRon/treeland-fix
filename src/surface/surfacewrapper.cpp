...
void SurfaceWrapper::setup()
{
    ...
    if (m_type == Type::XdgToplevel || m_type == Type::XWayland) {
        m_shellSurface->safeConnect(&WToplevelSurface::minimumSizeChanged, this, [this] {
            updateSizeCapabilities();
        });
        m_shellSurface->safeConnect(&WToplevelSurface::maximumSizeChanged, this, [this] {
            updateSizeCapabilities();
        });
    }
    updateSizeCapabilities();
...
void SurfaceWrapper::updateSizeCapabilities()
{
    ...
    const bool resizable = m_shellSurface->isResizable();
    const bool maximizable = m_shellSurface->isMaximizable();
