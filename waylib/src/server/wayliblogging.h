...
Q_DECLARE_LOGGING_CATEGORY(lcWlLinuxDmabuf)
Q_DECLARE_LOGGING_CATEGORY(lcWlLinuxDrmSyncobj)
Q_DECLARE_LOGGING_CATEGORY(lcWlPresentation)
...
Q_DECLARE_LOGGING_CATEGORY(lcWlVulkanCompositor)
